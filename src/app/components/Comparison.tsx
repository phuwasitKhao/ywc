      ...
      >
        ...
        <div className="mb-4 relative">
          <div className="flex flex-col md:flex-row">
            <div
              className="w-full md:w-1/2 p-4 rounded-l-lg"
                ...
                <div className="relative h-64 md:h-80 overflow-hidden rounded-lg">
                  {comparisonData[activeTab].aiContent.imageUrl && (
                    <Image
                      ...
                      alt={
                        comparisonData[activeTab].aiContent.title || "AI art"
                      }
                      fill
              ...
              {comparisonData[activeTab].type === "Art/Design" ? (
                ...
                <div className="h-64 md:h-80 overflow-y-auto p-4 bg-secondary rounded-lg">
                  {comparisonData[activeTab].type === "Code Snippet" ? (
                    ...
                    <>
                      {comparisonData[activeTab].humanContent.title && (
                        <h3 className="text-xl font-medium mb-3 text-teal-light">
                          {comparisonData[activeTab].humanContent.title}
                        </h3>
                      )}
        ...
        <div className="relative mt-8 mb-4 px-4 flex justify-center">
          <input
            type="range"
            min="0"
            max="100"
            ...
            className="w-1/2 h-2 rounded-lg appearance-none cursor-pointer interactive"
            style={{
