...
const aiStrengths: Strength[] = [
  {
    ...
    description:
      "AI can generate content in seconds, handling high volumes efficiently without fatigue.",
    icon: "⚡",
  ...
  },
  {
    ...
    description:
      "Can analyze and synthesize vast amounts of information beyond human capacity.",
    icon: "📊",
  ...
  },
  {
    title: "Consistency",
    description:
      "Maintains the same quality and style across multiple pieces without variation.",
    icon: "🔄",
  ...
  },
  {
    title: "Scalability",
    description:
      "Can produce content in multiple languages and formats simultaneously.",
    icon: "📈",
...
const humanStrengths: Strength[] = [
  {
    ...
    description:
      "Humans understand nuanced emotions and can create content that genuinely resonates.",
    icon: "❤️",
  ...
  },
  {
    ...
    description:
      "Can make unexpected creative leaps and develop truly original concepts.",
    icon: "💡",
  ...
  },
  {
    ...
    description:
      "Intrinsic understanding of cultural nuances, trends, and societal sensitivities.",
    icon: "🌍",
  ...
  },
  {
    ...
    description:
      "Can make complex ethical decisions based on values and understand moral implications.",
    icon: "⚖️",
    ...
    <div className="component-section">
      ...
      >
        ...
        <div className="flex justify-center mb-12">
          <motion.div
            className=" p-1 rounded-full flex gap-5"
            variants={itemVariants}
          >
            <button
        ...
        <motion.div
          ...
          animate={inView ? "visible" : "hidden"}
        >
          {(activeTab === "ai" ? aiStrengths : humanStrengths).map(
            (strength) => (
              <motion.div
                key={strength.title}
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${strength.color} opacity-10`}
                ></div>
        ...
        >
          <h3 className="text-2xl font-bold mb-4 text-center">
            The Ideal Future: <span className="text-accent">Collaboration</span>
          </h3>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              <h4 className="text-xl font-semibold mb-3 text-teal-light">
                Humans Provide:
              </h4>
              <ul className="space-y-2">
                <li className="flex items-start">
