...
const quizItems: QuizItem[] = [
  {
    content:
      "The city streets glistened with rain, each droplet a tiny mirror reflecting the neon signs above. Sarah pulled her coat tighter, watching her breath form clouds in the cold night air.",
    isAI: false,
    type: "Short story excerpt",
  },
  {
    content:
      "Research indicates that intermittent fasting may provide numerous health benefits, including improved metabolic health, reduced inflammation, and enhanced cellular repair processes. However, individual responses vary significantly.",
    isAI: true,
    type: "Health article",
  },
  {
    content:
      "Feeling so blessed today! 🙌 Just hiked up to Mirror Lake and the views were INSANE. Nature is the ultimate therapy. #blessed #adventure #nofilterneeded",
    isAI: false,
    type: "Social media post",
  },
  {
    content:
      "The quantum fluctuations in the early universe provided the seeds for the cosmic structures we observe today, including galaxies, galaxy clusters, and the cosmic web of dark matter.",
    isAI: true,
    type: "Scientific explanation",
  },
  {
    content:
      "Sipping coffee on my balcony watching the sunrise paint the sky, I'm reminded how tiny moments can hold immense beauty. Sometimes, we just need to pause to notice them.",
    isAI: true,
...
export default function Quiz() {
  ...
  const [alreadyAnswered, setAlreadyAnswered] = useState<boolean[]>(
    Array(quizItems.length).fill(false)
  );
  ...
  return (
    <div className="component-section">
      ...
      >
        ...
        >
          <span className="heading-gradient">Test Your</span> AI Detection
          Skills
        </motion.h2>
          ...
          {!showResult ? (
            <>
              <div className="mb-8">
                <div className="flex justify-between text-sm mb-2">
                  <span>
                    Question {currentItem + 1} of {quizItems.length}
                  </span>
                ...
                <div className="w-full bg-primary-light rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${((currentItem + 1) / quizItems.length) * 100}%`,
                    }}
                  ></div>
                </div>
              </div>
              ...
              >
                ...
                <div className="bg-primary-light p-6 rounded-lg mb-8 text-lg">
                  <p>
                    {`"`}
                    {quizItems[currentItem].content}
                    {`"`}
                  </p>
                </div>

                <p className="text-center mb-8 text-xl">
                  Was this created by AI or a human?
                </p>
                ...
                {alreadyAnswered[currentItem] && (
                  <div className="text-center mb-8">
                    ...
                    >
                      {userAnswers[currentItem] ? "Correct! " : "Incorrect. "}
                      This was created by{" "}
                      {quizItems[currentItem].isAI ? "AI" : "a human"}.
                    </p>
                  </div>
                )}
            ...
            >
                ...
                <div className="relative w-48 h-48 mx-auto">
                  <svg viewBox="0 0 100 100" className="w-full h-full">
                    ...
                    <circle
                      ...
                      strokeWidth="10"
                      strokeDasharray={`${
                        (2 * Math.PI * 45 * score) / quizItems.length
                      } ${2 * Math.PI * 45 * (1 - score / quizItems.length)}`}
              ...
              {hasVoted && (
                ...
                >
                  Thanks for sharing your perspective! The future likely
                  involves a collaborative relationship between humans and AI.
                </motion.p>
              )}
