...
const contentTypes: string[] = ['Articles', 'Images', 'Videos', 'Code', 'Music', 'Designs']
    ...
    <div className="content-container min-h-screen flex flex-col justify-center">
      ...
      >
        ...
        <motion.p 
          ...
          variants={childVariants}
        >
          Will AI replace human content creators, or will we find a new symbiotic relationship?
          Explore the evolving landscape of creativity in the age of artificial intelligence.
        </motion.p>
